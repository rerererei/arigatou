...
<div class="footerFix row justify-content-end pcview">
    <div class="col-2 text-center contact-btn to-button" href="#contactForm"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/web.png" style="width: 2.5vw;margin-bottom:5px;">WEBから<br>応募・問い合わせ</div>
    <div class="col-2 text-center tel-btn"><a href="tel:08054005639"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/phone.png" style="width: 2.5vw;margin-bottom:5px;">電話から<br>応募・問い合わせ</a></div>
</div>
<div class="footerFix-sp row spview">
    <div class="col-6 text-center contact-btn to-button" href="#contactForm"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/web.png" style="width: 6vw;margin-bottom:5px;">WEBから<br>応募・問い合わせ</div>
    <div class="col-6 text-center tel-btn"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/phone.png" style="width: 6vw;margin-bottom:5px;">電話から<br>応募・問い合わせ</a></div>
</div>
<!-- Head-->
...
<div class="features-area pcview">
    <div style="position: relative;">
        <div style="margin-bottom: -8vw;"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/tryangle.png" style="width: 100%;"></div>
    ...
    <div class="row bg-white" style="width:75%;margin: 2vw auto;margin-bottom: 0.3vw;border-radius: 1vw 1vw 0 0;">
        <div class="col-8" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/feature-num1.png);background-position-x: 3vw;background-position-y: 1vw;background-size: 8vw;">
        ...
        <div class="col-4 p-3" >
            <img class="w-100" src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/feature1.png">
        </div>
    </div>
    <div class="row problem-row bg-white" style="width:75%;margin: 0 auto;margin-bottom: 0.3vw;border-radius: 0;">
        <div class="col-4 p-3" >
            <img class="w-100" src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/feature2.png">
        </div>
        <div class="col-8" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/feature-num2.png);background-position-x: 35vw;background-position-y: 2vw;background-size: 8vw;">
    ...
    <div class="row problem-row bg-white" style="width:75%;margin: 2vw auto;margin-top: 0.3vw;border-radius: 0 0 1vw 1vw;">
        <div class="col-8" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/feature-num3.png);background-position-x: 3vw;background-position-y: 2vw;background-size: 8vw;">
        ...
        <div class="col-4 p-3" >
            <img class="w-100" src="<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/feature3.png">
        </div>
    </div>
</div>
...
<div id="requruite" class="requruite-area pcview">
    ...
    <div class="row">
        ...
        <div class="requruite-jokin" style="display:none">
            <div class="text-center mt-3" style="font-size: 1.5vw;font-weight: 400;">経験者の方は常勤での働き方も可能です♪</div>
            <div class="text-center mt-3 mb-5" style="font-size: 1.5vw;font-weight: 400;">責任者昇格で＋50,000円の手当支給！<br>また、常勤さんには社用車支給で、ご自宅の近くに会社負担で駐車場をお借りします。</div>
            <div class="reqruite-info">
                <table class="requruite-info-table">
                    <tr>
                        <th><div class="requruite-table-head">給与</div></td>
...
<div id="requruite-sp" class="requruite-area spview">
    ...
    <div class="row" style="margin-bottom: 5vw;">
        ...
        <div class="requruite-toroku">
            <div class="text-center mt-3" style="font-size: 3vw;font-weight: 400;">まずは登録のみからでOK！</div>
        ...
        <div class="requruite-jokin" style="display:none">
            <div class="text-center mt-3" style="font-size: 3vw;font-weight: 400;">経験者の方は常勤での働き方も可能です♪</div>
...
<div class="contact-area bg-image pcview" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/contact-bg.png);">
    <div class="contact-area bg-color">
        ...
        <div class="text-center mt-5 contact-btn to-button" href="#contactForm" style="font-size: 1.5vw;font-weight: 400;">Webから応募・問い合わせ</div>
    </div>
</div>
...
<div class="footer-area pcview">
    <div class="row" style="margin-right: 0;">
        <div class="col-2 text-center copy">
            <a href="#">個人情報保護方針</a>
        </div>
        <div class="col-8 text-center copy">

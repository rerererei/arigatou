...
<!-- requruite-->
<div id="requruite" class="requruite-area">
    <h2>recruitment</h2>
...
<!-- contact-->
<div class="contact-area bg-image" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/recruit/contact-bg.png);">
...
<!-- ContactForm -->
<div id="contactForm" class="form-area">
    <h2>form</h2>
